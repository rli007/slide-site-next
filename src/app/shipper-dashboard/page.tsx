      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            <h3 className="text-xl font-semibold mb-4">Welcome back, Shipper!</h3>
            <p className="text-gray-600 mb-6">Your dashboard is coming soon. Check back for shipping options and package tracking.</p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-indigo-50 rounded-lg p-6">
                <h4 className="font-semibold mb-2">Active Shipments</h4>
              ...
              <div className="bg-indigo-50 rounded-lg p-6">
                <h4 className="font-semibold mb-2">Delivered Packages</h4>
                <p className="text-2xl font-bold text-indigo-600">0</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-3">
                <button className="w-full bg-indigo-600 text-white font-semibold rounded-lg py-2 hover:bg-indigo-700 transition">Create Shipment</button>
